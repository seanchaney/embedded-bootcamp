...
**Methodology:** 
*   Skip abstract computer science theory in favor of practical hardware implementation.
...
*   **Capstone Options:**
    *   *Automotive Track:* **CAN Bus Node Network** — Two nodes exchanging sensor data over bxCAN. Implement a message protocol, decode traffic via logic analyzer, and apply MISRA-C basics.
    *   *Medical/Neurotech Track:* **Biosignal Data Logger** — Sample analog input via ADC+DMA, apply a digital filter (moving-average or IIR), and log data.
